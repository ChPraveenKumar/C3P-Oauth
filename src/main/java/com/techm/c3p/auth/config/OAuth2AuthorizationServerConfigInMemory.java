...
/**
 * This class is useful for storing the authorization server details in memory & db store. 
 * To enable in memory and DB, uncomment the below class level annotations
 * @author AR115998
 *
 */
//@Configuration
