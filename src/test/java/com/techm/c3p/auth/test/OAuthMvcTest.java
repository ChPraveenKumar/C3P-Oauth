...
import com.techm.c3p.auth.springboot.AuthorizationServerApplication;
...
public class OAuthMvcTest {
    ...
    private static final String EMAIL = "anjireddy.reddem@techmahindra.com";
    private static final String NAME = "Anjireddy";
    ...
    public void givenInvalidRole_whenGetSecureRequest_thenForbidden() throws Exception {
        final String accessToken = obtainAccessToken("testuser", "testuser@123");
    ...
    public void givenToken_whenPostGetSecureRequest_thenOk() throws Exception {
        final String accessToken = obtainAccessToken("admin", "admin@123");
